...
public class BoardLinhTinh {
    ...
    private int curX;
    private int curY;
    private ShapeLinhTinh curPiece;
    private Tetrominoe[] board;

    public BoardLinhTinh() {
    ...
    public boolean canMove(ShapeLinhTinh newPiece, int newX, int newY) {
        for (int i = 0; i < 4; i++) {
    ...
    public ShapeLinhTinh getCurPiece() {
        return curPiece;
    }
}
